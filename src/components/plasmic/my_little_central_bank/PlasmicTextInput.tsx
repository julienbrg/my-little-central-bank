...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: aAttJc8BJ4n/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "How many DUNE you want to issue today?" as const
        },
        props.args
      ),
    [props.args]
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__jmOvE)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kWnHf)}
                role={"img"}
              />
            ),
